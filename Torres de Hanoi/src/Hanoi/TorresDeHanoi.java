...
public class TorresDeHanoi implements Serializable {
    ...
    /**
     * Calcula la cantidad de movimientos que se requiere para mover de una
     * torre a otra
     *
     * @param numeroDiscos cantidad de discos que el usuario quiera ingresar
     * @return cantidad de movimientos
     */
    public int cantidadMovimientosMinimos(int numeroDiscos) {
        int resultado = 2;
